              ...
              {activeTab === "overview" ? (
                <>
                  ...
                  <TouchableOpacity
                    activeOpacity={0.9}
                    style={[
                      styles.overviewAddLauncher,
                      isCompact && styles.overviewAddLauncherCompact,
                    ]}
                  ...
                  >
                    <LinearGradient
                      ...
                      style={[
                        styles.overviewAddLauncherFill,
                        isCompact && styles.overviewAddLauncherFillCompact,
                      ]}
                    >
                      <View style={styles.overviewAddLauncherIcon}>
                        <Ionicons name="add" size={26} color="#082F49" />
                      </View>
                      <Text style={styles.overviewAddLauncherText}>
                        Add expense
                      </Text>
                    </LinearGradient>
                  </TouchableOpacity>
  ...
  const styles = StyleSheet.create({
    ...
    overviewAddLauncherCompact: {
      alignSelf: "stretch",
    },
    overviewAddLauncherFill: {
      minWidth: 260,
    ...
    overviewAddLauncherFillCompact: {
      minWidth: 0,
      width: "100%",
      paddingHorizontal: 26,
      paddingVertical: 20,
    },
    overviewAddLauncherIcon: {
      width: 42,
      height: 42,
      borderRadius: 21,
      alignItems: "center",
